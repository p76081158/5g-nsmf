...
func (a ByCpu) Less(i, j int) bool { return a[i].Cpu > a[j].Cpu }                     // descending sort
...
func (a ByBandwidth) Less(i, j int) bool { return a[i].Bandwidth > a[j].Bandwidth }   // descending sort
